...
#include<iostream>
using namespace std;//for input and output stream regulation
...
bool check_pass()
{
    ...
    string upassword;
     ...
     if ((userinput == username) && (upassword==password))
     {
         cout << "Access Granted..."<<endl;
         return true;
        
     }
    else if((userinput != username) || (upassword!=password))
...
{
    string dis_name;
    cout<<endl<<endl<<"*** Enter Disease Categories ***"<<endl<<endl;
    cout<<"\n1.Anesthetics"<<endl<<
    "2.Breast Screening"<<endl<<
    "3.Cardiology"<<endl<<
    "4.Ear, nose and throat (ENT)"<<endl<<
    "5.Elderly services department"<<endl<<
    "6.Gastroenterology"<<endl<<
    "7.General Surgery"<<endl<<
    "8.Gynecology"<<endl<<
    "9.Gendral Physician"<<endl<<
    "10.Neonatal Unit"<<endl<<
    "11.Neurology"<<endl<<
    "12.Nutrition and dietetics"<<endl<<
    "13.Obstetrics and gynecology units"<<endl<<
    "14.Oncology"<<endl<<
    "15.Ophthalmology"<<endl<<
    "16.Orthopedics"<<endl<<
    "17.Physiotherapy"<<endl<<
    "18.Renal Unit"<<endl<<
    "19.Sexual Health"<<endl<<
    "20.Urology"<<endl<<
    "21.Psychologist"<<endl;
    ...
    switch (dis_no) {
        case 1:
            cout<<"\nDoctor Name : Dr. Purvesh "<<endl
            <<"Floor No. 2 , Room No. 09 "<<endl;
            display_dis="Anesthetics";
            display_doc="Dr. Purvesh";
            doc_loc=" Floor No. 2 , Room No. 09 ";
            break;
            
        case 2:
            cout<<"\nDoctor Name : Dr. Harsh Yadav "<<endl
            <<"Floor No. 2 , Room No. 07 "<<endl;
            display_dis="Breast Screening";
            display_doc="Dr. Harsh Yadav";
            doc_loc="Location : Floor No. 2 , Room No. 07 ";
           
            break;
            
        case 3:
            cout<<"\nDoctor Name : Dr. Arrin Sharma "<<endl
            <<"Floor No. 2 , Room No. 05 "<<endl;
            display_dis="Cardiology";
            display_doc="Dr. Arrin Sharma";
            doc_loc="Location : Floor No. 2 , Room No. 05 ";
           
            break;
            
        case 4:
            cout<<"\nDoctor Name : Dr. Vartika Sharma "<<endl
            <<"Floor No. 2 , Room No. 03 "<<endl;
            display_dis="Ear, nose and throat (ENT)";
            display_doc="Dr. Vartika Sharma";
            doc_loc="Location : Floor No. 2 , Room No. 03 ";
           
            break;
            
        case 5:
            cout<<"\nDoctor Name : Piyush Agrahari "<<endl
            <<"Floor No. 2 , Room No. 01 "<<endl;
            display_dis="Elderly services department";
            display_doc="Piyush Agrahari";
            doc_loc="Location : Floor No. 2 , Room No. 01 ";
           
            break;
            
        case 6:
            cout<<"\nDoctor Name : Dr. Sahil "<<endl
            <<"Floor No. 3 , Room No. 02 "<<endl;
            display_dis="Gastroenterology";
            display_doc="Dr. Sahil";
            doc_loc="Location : Floor No. 3 , Room No. 02 ";
           
            break;
            
        case 7:
            cout<<"\nDoctor Name : Dr. , MD Shivam Kumar "<<endl
            <<"Floor No. 3 , Room No. 04 "<<endl;
            display_dis="General Surgery";
            display_doc="Dr. , MD Shivam Kumar";
            doc_loc="Location : Floor No. 3 , Room No. 04 ";
           
            break;
            
        case 8:
            cout<<"\nDoctor Name : Dr. ,MD Vansh Gupta "<<endl
            <<"Floor No. 3 , Room No. 06 "<<endl;
            display_dis="Gynecology";
            display_doc="Dr. ,MD Vansh Gupta";
            doc_loc="Location : Floor No. 3 , Room No. 06 ";
           
            break;
            
        case 9:
            cout<<"\nDoctor Name : Dr. Ayush Kumar "<<endl
            <<"Floor No. 3 , Room No. 08 "<<endl;
            display_dis="Gendral Physician";
            display_doc="Dr. Ayush Kumar";
            doc_loc="Location : Floor No. 2 , Room No. 08 ";
           
            break;
            
        case 10:
            cout<<"\nDoctor Name : Dr. Ritish Chandel "<<endl
            <<"Floor No. 3 , Room No. 10 "<<endl;
            display_dis="Neonatal Unit";
            display_doc="Dr. Ritish Chandel";
            doc_loc="Location : Floor No. 3 , Room No. 10 ";
           
            break;
            
        case 11:
            cout<<"\nDoctor Name : Dr. Muskaan "<<endl
            <<"Floor No. 1 , Room No. 10 "<<endl;
            display_dis="Neurology";
            display_doc="Dr. Muskaan";
            doc_loc="Location : Floor No. 1, Room No. 10 ";
           
            break;
            
        case 12:
            cout<<"\nDoctor Name : Dr. Veerpal "<<endl
            <<"Floor No. 1 , Room No. 09 "<<endl;
            display_dis="Nutrition and dietetics";
            display_doc="Dr. Veerpal";
            doc_loc="Location : Floor No. 1 , Room No. 09 ";
           
            break;
            
        case 13:
            cout<<"\nDoctor Name : Dr. Aditya Kumar "<<endl
            <<"Floor No. 1 , Room No. 08 "<<endl;
            display_dis="Obstetrics and gynecology units";
            display_doc="Dr. Aditya Kumar";
            doc_loc="Location : Floor No. 1 , Room No. 08 ";
           
            break;
            
        case 14:
            cout<<"\nDoctor Name : Dr. Ishrat Ali "<<endl
            <<"Floor No. 1 , Room No. 07 "<<endl;
            display_dis="Oncology";
            display_doc="Dr. Ishrat Ali";
            doc_loc="Location : Floor No. 1 , Room No. 07 ";
           
            break;
            
        case 15:
            cout<<"\nDoctor Name : Dr. Saksham Kumar "<<endl
            <<"Floor No. 1 , Room No. 06 "<<endl;
            display_dis="Ophthalmology";
            display_doc="Dr. Saksham Kumar";
            doc_loc="Location : Floor No. 1 , Room No. 06 ";
           
            break;
            
        case 16:
            cout<<"\nDoctor Name : Dr. Aman Singh "<<endl
            <<"Floor No. 4 , Room No. 09 "<<endl;
            display_dis="Orthopedics";
            display_doc="Dr. Aman Singh";
            doc_loc="Location : Floor No. 4 , Room No. 09 ";
           
            break;
            
        case 17:
            cout<<"\nDoctor Name : Dr. Krishna Patel "<<endl
            <<"Floor No. 4 , Room No. 07 "<<endl;
            display_dis="Physiotherapy";
            display_doc="Dr. Krishna Patel";
            doc_loc="Location : Floor No. 4 , Room No. 07 ";
           
            break;
            
        case 18:
            cout<<"\nDoctor Name : Dr. Ravi "<<endl
            <<"Floor No. 4 , Room No. 05 "<<endl;
            display_dis="Renal Unit";
            display_doc="Dr. Ravi";
            doc_loc="Location : Floor No. 4 , Room No. 05 ";
           
            break;
            
        case 19:
            cout<<"\nDoctor Name : Dr. Lovepreet Singh "<<endl
            <<"Floor No. 4 , Room No. 03 "<<endl;
            display_dis="Sexual Health";
            display_doc="Dr. Lovepreet Singh";
            doc_loc="Location : Floor No. 4 , Room No. 03 ";
           
            break;
            
        case 20:
            cout<<"\nDoctor Name : Divyansh"<<endl
            <<"Floor No. 4 , Room No. 01 "<<endl;
            display_dis="Urology";
            display_doc="Divyansh";
            doc_loc="Location : Floor No. 4 , Room No. 01 ";
            
        case 21:
            cout<<"\nDoctor Name : Dr. Riya"<<endl
            <<"Floor No. 4 , Room No. 11 "<<endl;
            display_dis="Psychologist";
            display_doc="Dr. Riya";
            doc_loc="Location : Floor No. 4 , Room No. 11 ";
 ...
 cin>>DOB11[T1.tempa].year;
 while(DOB11[T1.tempa].year>T1.current_year)  //to ensure that the year of birth
 ...
 while(DOB11[T1.tempa].year<1000)
 {
 ...
 while(DOB11[T1.tempa].year<1900)
 {
  ...
  if(birth_answer=='n'||birth_answer=='N')
  {
   ...
   while(DOB11[T1.tempa].year>T1.current_year)
   {
 ...
 cin>>DOB11[T1.tempa].month;
 while(DOB11[T1.tempa].month<=0||DOB11[T1.tempa].month>12)
 {
 ...
 switch(DOB11[T1.tempa].month)
 {
  ...
  case 10:
  case 12:{
           cin>>DOB11[T1.tempa].date;           //for months with 31 days
           while(DOB11[T1.tempa].date<1||DOB11[T1.tempa].date>31)
           {
            
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
            
            cin>>DOB11[T1.tempa].date;
            cout<<"\n";
           }
           break;
          }
  case 2:{                                  //for february
          cin>>DOB11[T1.tempa].date;
          if(DOB11[T1.tempa].year%4==0)
          {
           while(DOB11[T1.tempa].date<0||DOB11[T1.tempa].date>29)  //for leap year
           {
          ...
          {
           while(DOB11[T1.tempa].date<0||DOB11[T1.tempa].date>28)  //for non-leap year
           {
 ...
 default:{
          cin>>DOB11[T1.tempa].date;            //for other months
          while(DOB11[T1.tempa].date<1||DOB11[T1.tempa].date>30)
          {
 ...
 if(T1.regis>0&&T1.regis<T1.serial&&T1.entry_index[T1.regis]==1)
 {
  ...
  switch(PI[T1.regis].bld_group)
  {
   ...
   case 8:{
     ...
     cout<<"\tDisease Category : "<<display_dis<<endl;
     cout<<"\tConsulted by     : "<<display_doc<<endl;
     cout<<"\tLocation         : "<<doc_loc<<endl;
...
void all::software_detail()
{
 ...
 cout<<"\n\n\n\t\t\t ***SOFTWARE DETAILS***\n";
 cout<<"\n\n\tDeveloper                : Quality Squad "<<"\n";
 cout<<"\tProgramming Language     : C++ "<<"\n";
 cout<<"\tCompiler version         : X Code "<<"\n";
